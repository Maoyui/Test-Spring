        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="(item,index) in addressListFilter" :key="item.value" v-bind:class="{'check':checkIndex==index}" @click="checkIndex=index;selectedAddrId=item.addressId">
                    <dl>
                      <dt>{{item.userName}}</dt>
...
<script>
  ...
  export default{
      ...
      computed: {
        addressListFilter() {
          return this.addressList.slice(0,this.limit)  //数组动态控制
        }
      },
